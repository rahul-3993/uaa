...
public class IntegrationTestUtils {
    ...
    public static final String PREDIX_LANDING_PAGE_MESSAGE = "You should not see this page. Set up your redirect URI.";
    public static final String PREDIX_TITLE = "Predix";
