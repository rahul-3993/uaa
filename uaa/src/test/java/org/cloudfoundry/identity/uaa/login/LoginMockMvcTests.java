...
public class LoginMockMvcTests {
    ...
    @Test
    public void login_formLacksCsrfToken_invalidLoginRequest() throws Exception {
    ...
    @Test
    public void login_formContainsInvalidCsrfToken_invalidLoginRequest() throws Exception {
        BiConsumer<MockHttpSession, MockHttpServletRequestBuilder> formManipulator = (session, request) -> {
    ...
    void testChangePasswordSubmitDoesValidateCsrf(
        ...
        assumeFalse(isLimitedMode(limitedModeUaaFilter), "Test only runs in non limited mode.");
        ScimUser user = createUser(scimUserProvisioning, generator, IdentityZone.getUaaZoneId());
        RequestPostProcessor securityContext = securityContext(MockMvcUtils.getUaaSecurityContext(user.getUserName(), webApplicationContext, IdentityZoneHolder.getCurrentZoneId()));
        MockHttpSession session = new MockHttpSession();
