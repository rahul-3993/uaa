...
public class BootstrapTests {
    ...
    public void defaults_and_required_properties() throws Exception {
        ...
        String activeProfiles = profiles == null ? "default,degraded" : profiles.concat(",degraded");

        context = getServletContext(activeProfiles, false, new String[] {"login.yml", "uaa.yml", "required_configuration.yml"}, "file:./src/main/webapp/WEB-INF/spring-servlet.xml");
    ...
    public void all_properties_set() throws Exception {
        ...
        context = getServletContext("degraded,default", false, new String[] {"login.yml", "uaa.yml", "test/bootstrap/all-properties-set.yml"}, "file:./src/main/webapp/WEB-INF/spring-servlet.xml");
