...
class IdentityZoneEndpointDocs extends EndpointDocs {
    ...
    @Test
    void createKeyProviderConfig() throws Exception {
    ...
    @Test
    void retrieveKeyProviderConfig() throws Exception {
    ...
    @Test
    void findAllKeyProviderConfigs() throws Exception {
    ...
    @Test
    void deleteKeyProviderConfig() throws Exception {
