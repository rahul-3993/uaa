...
public class UaaDefaultCookieSerializer implements CookieSerializer {

    private static final Log logger = LogFactory.getLog(UaaDefaultCookieSerializer.class);
    ...
    public void writeCookieValue(CookieValue cookieValue) {
        ...
        if ("".equals(cookieValue.getCookieValue())) {
            sb.append("; Max-Age=").append(0);
        }
            ...
            sb.append("; Max-Age=").append(Integer.MAX_VALUE);
        }
        else if (this.cookieMaxAge > -1) {
